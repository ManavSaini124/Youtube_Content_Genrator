            ...
            <div className='grid grid-cols-1 md:grid-cols-2 gap-6 '>
                ...
                <div className="border rounded-2xl bg-white dark:bg-neutral-900 shadow-sm p-6">
                    ...
                    {content?.content?.titles.map((title, index) => (
                        <div key={index} className="p-4 border rounded-lg bg-gray-50 dark:bg-neutral-800">
                        <h3 className="text-lg font-semibold">{title.title}</h3>
                        <p className="text-sm text-gray-500">SEO Score: {title.seo_score}</p>
                        </div>
                    ))}
                    </div>
                </div>
                ...
                <div className="border rounded-2xl bg-white dark:bg-neutral-900 shadow-sm p-6 relative">
                    ...
                    <p className="text-gray-700 dark:text-gray-300">{content?.content?.description}</p>
                    <Button
                ...
                <div className="border rounded-2xl bg-white dark:bg-neutral-900 shadow-sm p-6">
                    ...
                    <div className="flex flex-wrap gap-2">
                        {content?.content?.image_prompts.map((prompt: string, index: number) => (
